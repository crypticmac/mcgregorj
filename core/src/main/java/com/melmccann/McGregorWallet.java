 ...
 */
public class McGregorWallet extends Wallet {
    public McGregorWallet(NetworkParameters params) {
        super(params);
    }

    public McGregorWallet(NetworkParameters params, KeyCrypter keyCrypter) {
